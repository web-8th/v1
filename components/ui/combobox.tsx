    ...
    <ComboboxPrimitive.Portal>
      ...
      >
        <ComboboxPrimitive.Popup
          ...
          data-chips={!!anchor}
          className={cn(
            `group/combobox-content relative max-h-96 w-(--anchor-width)
            max-w-(--available-width) min-w-[calc(var(--anchor-width)+--spacing(7))]
            origin-(--transform-origin) overflow-hidden rounded-md bg-popover
            ...
            *:data-[slot=input-group]:h-8 *:data-[slot=input-group]:border-input/30
            *:data-[slot=input-group]:bg-input/30 *:data-[slot=input-group]:shadow-none
  ...
  return (
    <ComboboxPrimitive.Item
      ...
      className={cn(
        ...
        pl-2 text-sm outline-hidden select-none data-highlighted:bg-accent
...
function ComboboxLabel({ className, ...props }: ComboboxPrimitive.GroupLabel.Props) {
  return (
    <ComboboxPrimitive.GroupLabel
      ...
      className={cn(
        `px-2 py-1.5 text-xs text-muted-foreground pointer-coarse:px-3 pointer-coarse:py-2
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn(
        ...
        transition-[color,box-shadow] focus-within:border-ring focus-within:ring-[3px]
        focus-within:ring-ring/50 has-aria-invalid:border-destructive
        has-aria-invalid:ring-[3px] has-aria-invalid:ring-destructive/20
        has-data-[slot=combobox-chip]:px-1.5 dark:bg-input/30
  ...
  return (
    <ComboboxPrimitive.Chip
      ...
      className={cn(
        ...
        has-disabled:opacity-50 has-data-[slot=combobox-chip-remove]:pr-0`,
        className
      )}
      {...props}
    >
