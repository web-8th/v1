  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        rounded-md p-0 text-sidebar-foreground ring-sidebar-ring outline-hidden
        transition-transform peer-hover/menu-button:text-sidebar-accent-foreground
  ...
  return (
    <div
      ...
      className={cn(
        ...
        rounded-md px-1 text-xs font-medium text-sidebar-foreground tabular-nums
        select-none`,
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        px-2 text-sidebar-foreground ring-sidebar-ring outline-hidden
        hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2
